...
export function PlaylistItem({ data }: { data: Playlist }) {
  return (
    <Link
      ...
      className="group relative flex h-12 w-full min-w-[300px] max-w-[600px] gap-2 overflow-hidden rounded-sm bg-secondary/70 transition-colors hover:bg-secondary hover:no-underline"
    >
